...
const LINKS = [
  ...
  },
  {
    ...
    items: [
      {
        title: "NEFSCUN",
        link: "https://www.nefscun.org.np/",
        isContact: false,
      },
      {
        title: "Bhaktapur Department of Co-operative",
        link: "https://bhaktapurdcu.coop.np/  ",
        isContact: false,
      },
      {
        title: "Department of Co-operative, Nepal Government",
        link: "https://www.deoc.gov.np/",
        isContact: false,
      },
    ],
  },
    ...
    <footer className="relative w-full bg-[#000625] py-8 mt-16">
      <div className="mx-auto w-full max-w-7xl px-16">
        <div className="grid grid-cols-1 lg:flex lg:flex-row justify-between gap-4   ">
          <div className="sm:basis-full lg:basis-1/3">
            <Typography
              ...
              color="white"
              variant="h5"
              className=" flex mb-2 sm:justify-center"
            >
              A a s t h a L o g o
            </Typography>
            ...
            {LINKS.map((item, index) => (
              <ul key={index}>
                <Typography
                  ...
                  variant="small"
                  color="white"
                  className="mb-1 font-medium text-lg underline"
                >
                  {item.title}
                </Typography>
                {item.items?.map((subItem, index) => (
                  <li key={index}>
                    <Typography
                      ...
                      as="a"
                      color="white"
                      className={`py-0.5 font-normal text-white font-thin  ${
                        !subItem.isContact &&
        ...
        <div className="mt-5 flex w-full  border-t border-blue-gray-50 py-1">
          ...
          >
            &copy; {currentYear} Developed by Nirjal Prajapati and Designed by
            Ram Katwal. All Rights Reserved.
          </Typography>
        </div>
      </div>
    </footer>
